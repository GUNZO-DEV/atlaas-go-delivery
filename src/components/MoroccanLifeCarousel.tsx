...
const scenes = [{
  ...
  illustration: <div className="relative">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2">
          ...
          <div className="w-2 h-16 bg-white/30 blur-md animate-[rise_2s_ease-in-out_infinite_0.5s] rounded-full absolute left-4" style={{
        animationDelay: '0.3s'
      }} />
          <div className="w-2 h-16 bg-white/30 blur-md animate-[rise_2s_ease-in-out_infinite_1s] rounded-full absolute -left-4" style={{
        animationDelay: '0.6s'
      }} />
        </div>
      </div>
  ...
  illustration: <div className="relative">
        ...
        <div className="absolute -top-4 right-8 text-3xl animate-[float_3.5s_ease-in-out_infinite]" style={{
      animationDelay: '0.5s'
    }}>🏮</div>
        <div className="absolute bottom-4 left-0 text-2xl opacity-70 animate-[float_4s_ease-in-out_infinite]" style={{
      animationDelay: '1s'
    }}>✨</div>
        <div className="absolute bottom-8 right-4 text-2xl opacity-70 animate-[float_4.5s_ease-in-out_infinite]" style={{
      animationDelay: '1.5s'
    }}>✨</div>
      </div>
}, {
  ...
  illustration: <div className="relative">
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-2">
          ...
          <div className="w-12 h-1 bg-primary/30 rounded animate-[speed_1s_linear_infinite]" style={{
        animationDelay: '0.1s'
      }} />
          <div className="w-20 h-1 bg-primary/40 rounded animate-[speed_1s_linear_infinite]" style={{
        animationDelay: '0.2s'
      }} />
        </div>
      </div>
  ...
  illustration: <div className="relative">
        ...
        <div className="absolute top-8 left-0 text-2xl animate-[float_3s_ease-in-out_infinite]" style={{
      animationDelay: '0.5s'
    }}>🧂</div>
        <div className="absolute bottom-0 right-0 text-2xl animate-[float_3.5s_ease-in-out_infinite]" style={{
      animationDelay: '1s'
    }}>🌿</div>
      </div>
}, {
  ...
  illustration: <div className="relative">
        ...
        {/* Hearts */}
        <div className="absolute top-4 right-0 text-3xl animate-[float_3s_ease-in-out_infinite]" style={{
      animationDelay: '0.3s'
    }}>❤️</div>
        <div className="absolute bottom-8 left-0 text-2xl animate-[float_3.5s_ease-in-out_infinite]" style={{
      animationDelay: '0.6s'
    }}>💚</div>
        <div className="absolute bottom-4 right-4 text-2xl animate-[float_4s_ease-in-out_infinite]" style={{
      animationDelay: '0.9s'
    }}>💛</div>
      </div>
}];
const MoroccanLifeCarousel = () => {
  ...
  return <div className="relative w-full h-full min-h-[500px] rounded-3xl overflow-hidden shadow-elevation">
      ...
      {/* Navigation arrows */}
      <button onClick={prevScene} className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white rounded-full p-3 transition-all hover:scale-110 z-20">
        <ChevronLeft className="w-6 h-6" />
      </button>
      <button onClick={nextScene} className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-md text-white rounded-full p-3 transition-all hover:scale-110 z-20">
        <ChevronRight className="w-6 h-6" />
      </button>

      {/* Dots indicator */}
      <div className="absolute bottom-20 left-1/2 -translate-x-1/2 flex gap-2 z-20">
        {scenes.map((_, index) => <button key={index} onClick={() => goToScene(index)} className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentScene ? "bg-white w-8" : "bg-white/40 hover:bg-white/60"}`} />)}
      </div>
