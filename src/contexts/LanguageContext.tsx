...
export const translations: Translations = {
  ...
  'footer.developed': { en: 'Crafted with Moroccan pride at Al Akhawayn University', fr: 'Créé avec fierté marocaine à l\'Université Al Akhawayn' },
  'footer.developedBy': { en: 'by MT', fr: 'par MT' },
